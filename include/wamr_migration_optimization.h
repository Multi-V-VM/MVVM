...
public:
    ...
    void computeStateDelta(const void* old_state, const void* new_state, 
    ...
    size_t decompressData(const void* input, size_t input_size,
                         void* output, size_t output_capacity);
    ...
    MigrationStrategy selectOptimalStrategy(size_t state_size, 
