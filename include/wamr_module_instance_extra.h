...
template <SerializerTrait<WASMGlobalInstance *> T> void dump(T t, WASMGlobalInstance *env) { t->dump_impl(env); }

template <SerializerTrait<WASMGlobalInstance *> T> void restore(T t, WASMGlobalInstance *env) { t->restore_impl(env); }
